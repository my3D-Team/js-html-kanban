...
var SwitchButton = React.createClass({displayName: "SwitchButton",
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "topActionBtn", style: {display: switchBtnDisplayed}, onClick: this.onSwitchModeClick, title: labels.MENU.HEADER.TITLE.SWITCH_MODE}, 
...
var PlayButton = React.createClass({displayName: "PlayButton",
    ...
    render: function () {
        return (
            React.createElement("div", {className: "topActionBtn", onClick: this.switchIcon, title: labels.MENU.HEADER.TITLE.SLIDESHOW}, 
                React.createElement("i", {className: this.state.text})
            )
            )
    }
});
var MeetingButton = React.createClass({displayName: "MeetingButton",
    ...
    render: function () {
        if (this.props.main.isMeetingMode) {
            return (
                React.createElement("div", {className: "topActionBtn meetingMode", onClick: this.onClick, title: labels.MENU.HEADER.TITLE.MEETING_MODE}, 
                    React.createElement("i", {className: "fa fa-users"})
                )
                )
        } else {
            return (
                React.createElement("div", {className: "topActionBtn", onClick: this.onClick, title: labels.MENU.HEADER.TITLE.MEETING_MODE}, 
                    React.createElement("i", {className: "fa fa-users"})
                )
                )
        }
...
var ClockShow = React.createClass({displayName: "ClockShow",
    getInitialState: function () {
        var model = {};
        model.time = "00:00";
        model.current = 0;
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "topActionBtn clockShow", style: {display: clockDisplayed}}, 
               this.state.time
            )
            )
    }
...
var HistoryButton = React.createClass({displayName: "HistoryButton",
    ...
    render: function () {
        return (
            React.createElement("div", {className: "topActionBtn", onClick: this.onClick, title: labels.MENU.HEADER.TITLE.HISTORY}, 
...
var QuitButton = React.createClass({displayName: "QuitButton",
    onClick : function () {
        this.props.main.topMenuEventHandle._onClickLogout();
    },
    render: function () {
        return (
            React.createElement("div", {className: "topActionBtn", onClick: this.onClick, title: labels.MENU.HEADER.TITLE.QUIT}, 
...
var SettingButton = React.createClass({displayName: "SettingButton",
    getInitialState: function () {
        var model = {};
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "topDropDownIcoLabel", onMouseOver: this.onMouseEnter, onMouseOut: this.onMouseOut}, 
                React.createElement("div", {className: "topActionBtn", title: labels.MENU.HEADER.TITLE.SETTINGS}, 
                    React.createElement("i", {className: "fa fa-cog"})
                ), 

                React.createElement("div", {className: "dropDownItemWrapper", onMouseEnter: this.onMouseEnter, onMouseOut: this.onMouseOut, style: {display: displayed, marginLeft: "-80px", minWidth: "150px"}}, 
                    React.createElement("div", {className: "dropDownItem"}, 
                        React.createElement("p", {className: "topLabel topLabelEnabled", onMouseEnter: this.onMouseEnter, onClick: this.onClickClfSquare}, labels.MENU.HEADER.SETTINGS_BUTTON.CLF)
                    ), 
                    React.createElement("div", {className: "dropDownItem"}, 
                        React.createElement("p", {className: "topLabel topLabelEnabled", onMouseEnter: this.onMouseEnter, onClick: this.onClickSupport, title: labels.MENU.HEADER.SETTINGS_BUTTON.SUPPORT}, labels.MENU.HEADER.SETTINGS_BUTTON.SUPPORT)
                    ), 
                    React.createElement("div", {className: "dropDownItem"}, 
                        React.createElement("p", {className: "topLabel topLabelEnabled ", onMouseEnter: this.onMouseEnter, onClick: this.onClickUserGuide}, labels.MENU.HEADER.SETTINGS_BUTTON.USER_GUIDE)
                    ), 
                    React.createElement("div", {className: "dropDownItem"}, 
                        React.createElement("p", {className: "topLabel topLabelEnabled", onMouseEnter: this.onMouseEnter, onClick: this.onClickTurnOffHighlighting}, highlight)
                    ), 
                    React.createElement("div", {className: "dropDownItem"}, 
                        React.createElement("p", {className: "topLabel topLabelEnabled", onMouseEnter: this.onMouseEnter, onClick: this.onClickExportCsv}, labels.MENU.HEADER.SETTINGS_BUTTON.CSV_FORMAT)
                    ), 
                    React.createElement("div", {className: "dropDownItem"}, 
                        React.createElement("p", {className: "topLabel topLabelEnabled", onMouseEnter: this.onMouseEnter, onClick: this.onClickExportPng}, labels.MENU.HEADER.SETTINGS_BUTTON.PNG_FORMAT)
                    )
                )
            )
            )
    ...
    render: function () {
        ...
        return (
            React.createElement("div", null, 
                React.createElement("div", {className: "topBtn", onClick: this.onLogoClick, title: labels.MENU.HEADER.TITLE.HOME}, 
                    React.createElement("img", {alt: "logo_login", src: "images/logo_VVM.png"})
                ), 
                React.createElement("div", {className: "topDropDown"}, 
                    React.createElement("div", {className: "topBtn", title: labels.MENU.HEADER.TITLE.TOOLS}, 
                        React.createElement("i", {className: "fa fa-chevron-down topDropDownIco"}), 
                        React.createElement("p", {className: "topLabel"}, 
                        "Visual Management"
                        )
                    ), 
                    React.createElement("div", {className: "dropDownItemWrapper"}, 
                        this.state.tools.map(function (result, i) {
                            if (result.template) {
                                return (React.createElement("div", {className: "dropDownItem", key: i}, 
                                    React.createElement("p", {className: "topLabel topLabelDisabled"}, result.title)
                                ))
                            } else {
                                return (React.createElement("div", {className: "dropDownItem", key: i}, 
                                    React.createElement("p", {className: "topLabel topLabelEnabled", onClick: that.onToolsClick.bind(this, result), title: result.title}, result.title, " ")
                                ))
                            }
                        }, this)
                    )
                ...
                React.createElement("div", {className: "topDropDown"}, 
                    React.createElement("div", {className: "topBtn", title: labels.MENU.HEADER.TITLE.BOARDS}, 
                        React.createElement("i", {className: "fa fa-chevron-down topDropDownIco"}), 
                        React.createElement("p", {className: "topLabel"}, 
                        ...
                        model.boards.map(
                            function (item, i) {
                                if (item.engagementId) {
                                    return (React.createElement("div", {className: "dropDownItem", key: i}, 
                                        React.createElement("p", {className: "topLabel topLabelEnabled", onClick: that.onBoardClick.bind(this, item), title: item.name}, item.name)
                                    )
                                        )
                                } else {
                                    return (React.createElement("div", {className: "dropDownItem", key: i}, 
                                        React.createElement("p", {className: "topLabel topLabelDisabled"}, item.name)
                                    ))
                                }
                            }, this)
                    )
                ...
                React.createElement("div", {className: "topDropDown"}, 
                    React.createElement("div", {className: "topBtn", title: labels.MENU.HEADER.TITLE.ZOOMZONES}, 
                        React.createElement("i", {className: "fa fa-chevron-down topDropDownIco"}), 
                        React.createElement("p", {className: "topLabel"}, 
                    ...
                    React.createElement("div", {className: "dropDownItemWrapper"}, 
                                model.zoomZones.map(function (result, i) {
                                    return (React.createElement("div", {className: "dropDownItem", key: i}, 
                                        React.createElement("p", {className: "topLabel topLabelEnabled", onClick: this.onZoomZoneClick.bind(this, result), title: result.title}, result.title, " ")
                                    ))
                                }, this)
                    )
                )
