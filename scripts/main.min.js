...
var ProjectUsers = [
    ...
    },
    {
        ...
        "lastName": "LIAGRE",
        "firstName": "Alexandre",
        image: "https://s3.amazonaws.com/uifaces/faces/twitter/gerrenlamson/128.jpg"
    ...
    },
    {
        ...
        "lastName": "CHARDEVEL",
        "firstName": "Axel",
        image: "https://s3.amazonaws.com/uifaces/faces/twitter/jadlimcaco/128.jpg"
    }
];
"use strict";
        ...
        return (
            React.createElement("div", {className: "kanban", onMouseUp: this.onDeselectItem, onMouseMove: this.onMove}, 
                ...
                this.state.users.map(function (item, i) {
                        ...
                        return (React.createElement(User, {x: "375", y: y, item: item, key: i}, " "));
                    }
                ), 
                ...
                React.createElement(Sticky, {x: "50", y: "100", className: "info", dragBoard: this}), 
...
var Sticky = React.createClass({displayName: "Sticky",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: this.props.className + " sticky", style: css}, 
                React.createElement("i", {onMouseDown: this.onMouseDown, onMouseUp: this.onMouseUp, className: "fa fa-bars dragPin"}), 
                React.createElement("i", {onClick: this.onClick, className: "fa fa-pencil edit"})
            )
            );
    }
});
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "row", style: css}, 
                ...
                React.createElement("img", {src: this.props.item.image, alt: "", className: "avatar"})
            )
            );
    }
});
