...
var Kanban = React.createClass({displayName: "Kanban",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "kanban", onTouchEnd: this.onDeselectItem, onMouseUp: this.onDeselectItem, onTouchMove: this.onMove, onMouseMove: this.onMove}, 
...
var Sticky = React.createClass({displayName: "Sticky",
        ...
        render: function () {
            ...
            return (
                React.createElement("div", {className: this.props.className + " sticky", style: css, onTouchStart: this.onMouseDown, onTouchEnd: this.onMouseUp, onMouseDown: this.onMouseDown, onMouseUp: this.onMouseUp}, 
                    React.createElement("i", {onClick: this.onClick, onMouseDown: this.stopPropagation, onToucheStart: this.stopPropagation, className: "fa fa-pencil edit"})
                )
                );
        }
    })
